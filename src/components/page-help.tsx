...
const HELP_CONTENT: Record<string, { title: string; desc: string; steps: string[] }> = {
  ...
  "/settings/credentials": { title: "Credenciales y Acceso", desc: "Conecta tu cuenta de Google para acceder sin contraseña, recupera conexiones perdidas y gestiona la seguridad de tu cuenta.", steps: ["Conecta con Google para login rápido", "Recupera conexiones si perdiste acceso", "Activa 2FA para mayor seguridad", "Revisa y revoca sesiones activas"] },
