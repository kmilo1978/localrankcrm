...
import { Bell, BellRing, Calendar, CheckCircle2, Clock, Mail, MessageSquare, Phone, Plus, RefreshCw, Send, Settings, Trash2, X } from "lucide-react";
...
const SEED_REMINDERS: MeetingReminder[] = [
  { id: "mr1", meetingTitle: "Demo TechCorp — Propuesta Enterprise", meetingDate: "2026-07-22", meetingTime: "10:00", attendees: [{ name: "Carlos Ruiz", email: "carlos@techcorp.com", phone: "+52 55 1234 5678" }], channels: ["email", "whatsapp"], remindBefore: [1440, 60], autoEnabled: true, status: "scheduled", sentAt: "", createdAt: "2026-07-20" },
  { id: "mr2", meetingTitle: "Kickoff MediaGroup", meetingDate: "2026-07-23", meetingTime: "15:00", attendees: [{ name: "Roberto Méndez", email: "roberto@mediagroup.mx", phone: "+52 33 9876 5432" }, { name: "Ana López", email: "ana@localrank.co", phone: "" }], channels: ["email", "sms"], remindBefore: [1440, 30], autoEnabled: true, status: "scheduled", sentAt: "", createdAt: "2026-07-20" },
  { id: "mr3", meetingTitle: "Seguimiento LogiNext", meetingDate: "2026-07-21", meetingTime: "11:00", attendees: [{ name: "María García", email: "maria@loginext.io", phone: "+1 305 555 0123" }], channels: ["whatsapp"], remindBefore: [60, 15], autoEnabled: false, status: "sent", sentAt: "2026-07-21 10:00", createdAt: "2026-07-19" },
];
...
export default function MeetingRemindersPage() {
  ...
  function createReminder() {
    ...
    const reminder: MeetingReminder = {
      ...
      autoEnabled: form.autoEnabled, status: "scheduled", sentAt: "", createdAt: new Date().toISOString().split("T")[0]!,
    };
    save([reminder, ...reminders]);
    setForm({ meetingTitle: "", meetingDate: "", meetingTime: "", attendeeName: "", attendeeEmail: "", attendeePhone: "", attendees: [], channels: config.defaultChannels, remindBefore: config.defaultRemindBefore, autoEnabled: true });
