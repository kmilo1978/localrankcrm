...
const DOCUMENTATION: DocSection[] = [
  ...
  { category: "💼 CRM & Ventas", modules: [
    ...
    { title: "Cartera / Facturación", description: "Gestión completa de facturación, cobranza, acuerdos de pago y cancelaciones. Paginación de 10 facturas por página.", howTo: ["Crea facturas con cliente, monto y fecha de vencimiento", "Marca como pagada con un clic", "Edita cualquier factura (cliente, monto, fecha, estado)", "Crea acuerdos de pago para deudas en cuotas", "Ve el historial de gestiones de cobranza", "Envía recordatorios por WhatsApp, Email o llamada"], tips: ["Las facturas vencidas aparecen resaltadas en rojo", "Los acuerdos de pago trackean cuotas e incumplimientos", "Puedes duplicar facturas para crear recurrentes"] },
  ]},
  ...
  { category: "🤖 Automatización & IA", modules: [
    { title: "Asistente IA", description: "Chat inteligente con acceso a TODOS los datos del CRM. Soporta voz. Pregunta sobre contactos, leads, tareas, facturas, proyectos y más.", howTo: ["Haz clic en el botón ✨ (esquina inferior derecha)", "Escribe tu pregunta o usa el botón 🎙️ para hablar", "El asistente busca en tus datos reales y responde", "Tiene acceso a: contactos, leads, pipeline, tareas, notas, to-do, checklists, proyectos, propuestas, facturas, proveedores, social outreach, recordatorios, formularios", "La conversación mantiene contexto (puedes hacer preguntas de seguimiento)"], tips: ["El micrófono funciona en Chrome y Edge", "Ante la duda, pregunta — la IA busca en todo el CRM", "No inventa datos: si no encuentra algo, te lo dice", "Preguntas fuera del CRM (recetas, política, etc.) son rechazadas"] },
  ...
  { category: "📋 Operación", modules: [
    { title: "Notas", description: "Notas con etiquetas compartidas, múltiples vistas, búsqueda y opción de enviar a recordatorio.", howTo: ["Crea notas con título, contenido e imagen", "Asigna etiquetas del sistema compartido", "Cambia entre vistas: Grid, Lista o Board (por categoría)", "Usa el botón 'Recordatorio' para programar un aviso", "Fija notas importantes con el pin 📌"], tips: ["Las etiquetas son compartidas con todos los módulos del CRM", "Puedes buscar notas por título o contenido", "El agente IA puede buscar en tus notas"] },
    { title: "To-Do", description: "Listas de pendientes organizadas por periodo: diario, semanal y mensual.", howTo: ["Selecciona el periodo (Diario/Semanal/Mensual)", "Escribe un item y presiona Enter para agregar", "Marca como completado con el checkbox", "Los items se organizan por periodo automáticamente"], tips: ["Útil para objetivos a corto vs largo plazo", "El agente IA puede decirte qué tienes pendiente en cada periodo"] },
    { title: "Checklists", description: "Listas de verificación con bloqueo, etiquetas, proyectos y reordenamiento. Paginación de 8 por página.", howTo: ["Crea un checklist con título, cliente y categoría", "Agrega items uno a uno o pega una lista completa", "Bloquea con el candado para evitar cambios accidentales", "Usa ↑↓ para reordenar las cards"], tips: ["Puedes clonar checklists para reutilizar con otros clientes", "Las etiquetas del CRM se pueden asignar al crear"] },
    { title: "Proyectos", description: "Gestión de proyectos con sub-proyectos, tareas, notas, secciones libres, equipo y archivos. Edición inline del nombre y descripción.", howTo: ["Crea un proyecto con nombre, descripción y color", "Agrega sub-proyectos para dividir en fases", "Agrega secciones libres (texto, links, listas)", "Asigna miembros del equipo con rol", "Agrega tareas y trackea progreso", "Edita nombre/descripción del proyecto con el ícono de lápiz", "Busca proyectos en el sidebar con el buscador"], tips: ["Cada sub-proyecto tiene sus propias tareas y notas", "La barra de progreso muestra % de tareas completadas", "Puedes duplicar proyectos completos"] },
    { title: "Propuestas", description: "Crea propuestas comerciales con secciones, branding, firma digital y tracking de vistas. Paginación y búsqueda.", howTo: ["Crea desde template o desde cero", "Edita secciones arrastrando y reorganizando", "Agrega logo, banner y firma del cliente", "Configura contraseña para proteger acceso", "Marca como enviada y trackea cuántas veces la vieron", "Busca propuestas por nombre o cliente en el sidebar"], tips: ["Los templates te ahorran tiempo en propuestas recurrentes", "El tracking de vistas te dice si el cliente abrió la propuesta"] },
