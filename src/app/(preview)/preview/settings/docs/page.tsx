...
const DOCUMENTATION: DocSection[] = [
  ...
  { category: "📋 Operación", modules: [
    { title: "Calendario", description: "Calendario con 3 vistas: Mes, Semana y Día. Gestiona citas, cobros y recordatorios con múltiples calendarios.", howTo: ["Cambia entre vistas Mes/Semana/Día con los botones del header", "Vista Mes: cuadrícula mensual, click en un día para ver detalles", "Vista Semana: grilla de 7 días por hora, click en un día para ir a vista Día", "Vista Día: timeline completo por hora con tarjetas de cita", "Crea citas con título, fecha, hora, duración y contacto", "Crea múltiples calendarios con colores para organizar (Citas, Cobros, Recordatorios)", "Filtra calendarios con los checkboxes del sidebar"], tips: ["En vista Semana puedes ver la carga de toda la semana de un vistazo", "Vista Día es ideal para planificar un día específico hora por hora", "Puedes conectar Google Calendar y Outlook desde el sidebar"] },
